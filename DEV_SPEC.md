...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2025-08-09 | FakeLLM 测试桩 + LLMFactory 工厂路由，20 个测试用例全部通过 |
...
| B6 | Evaluator 抽象接口与工厂 | [x] | 2025-08-10 | BaseEvaluator 抽象基类 + RetrievedChunk/GroundTruth/EvalResult 数据契约 + CustomEvaluator（hit_rate/mrr/recall@k/precision@k）+ EvaluatorFactory 工厂路由，58 个测试全部通过 |
